...
public class Database {
    ...
    public void loadAllPosts(ArrayList<marketplace.Post> posts) {
        try {
            ...
            while (title != null) {
                ...
                marketplace.Post post = (marketplace.Post) is.readObject();
                posts.add(post);
                title = br.readLine();
                is.close();
            }
    ...
    public static void main(String[] args) {
        ...
        ArrayList<marketplace.Post> posts = new ArrayList<>();
        database.loadAllPosts(posts);
        for (marketplace.Post post : posts) {
