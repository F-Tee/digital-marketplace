...
public class Guest extends Application implements Initializable {
    ...
    private static marketplace.Post currentPost;
    private static ArrayList<marketplace.Post> postList;

    private static ArrayList<marketplace.Post> sportList;
    private static ArrayList<marketplace.Post> cultureList;
    private static ArrayList<marketplace.Post> fasionList;
    private static ArrayList<marketplace.Post> foodList;
    private static ArrayList<marketplace.Post> fishingList;
    private static ArrayList<marketplace.Post> transportList;
    ...
    public void advertPageScreen(ActionEvent event, marketplace.Post post) throws Exception {
        currentPost = new marketplace.Post(post);
    ...
    public void loadLists() {
        if (postList != null) {
            for (marketplace.Post p : postList) {
                if (p.getCategory() == marketplace.Post.Category.SPORT) {
                    sportList.add(p);
                } else if (p.getCategory() == marketplace.Post.Category.CULTURE) {
                    cultureList.add(p);
                } else if (p.getCategory() == marketplace.Post.Category.FASHION) {
                    fasionList.add(p);
                } else if (p.getCategory() == marketplace.Post.Category.FOOD) {
                    foodList.add(p);
                } else if (p.getCategory() == marketplace.Post.Category.FISHING) {
                    fishingList.add(p);
                } else if (p.getCategory() == marketplace.Post.Category.TRANSPORT) {
                    transportList.add(p);
                }
            }
        }
